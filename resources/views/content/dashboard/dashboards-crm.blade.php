    ...
    <div class="col-xl-2 col-md-4 col-6 mb-4">
        <div class="card">
            <div class="card-header pb-0">
                ...
                <small class="text-muted">Last Montha</small>
            </div>
            <div class="card-body">
        ...
        <div class="card h-100">
            ...
            <div class="card-body">
                <ul class="p-0 m-0">
                    ...
                    <li class="mb-3 pb-1 d-flex">
                        <div class="d-flex w-50 align-items-center me-3">
                            <img src="{{asset('assets/img/icons/brands/figma-logo.png')}}" alt="figma-logo" class="me-3"
                                width="35" />
                            <div>
                    ...
                    <li class="mb-3 pb-1 d-flex">
                        <div class="d-flex w-50 align-items-center me-3">
                            <img src="{{asset('assets/img/icons/brands/vue-logo.png')}}" alt="vue-logo" class="me-3"
                                width="35" />
                            <div>
                    ...
                    <li class="mb-3 pb-1 d-flex">
                        <div class="d-flex w-50 align-items-center me-3">
                            <img src="{{asset('assets/img/icons/brands/react-logo.png')}}" alt="react-logo" class="me-3"
                                width="35" />
                            <div>
