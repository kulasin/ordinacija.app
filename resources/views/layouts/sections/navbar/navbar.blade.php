                ...
                <ul class="navbar-nav flex-row align-items-center ms-auto">
                    ...
                    <li class="nav-item dropdown-language dropdown me-2 me-xl-0">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li>
                                <a class="dropdown-item {{ app()->getLocale() === 'ba' ? 'active' : '' }}"
                                    href="{{url('lang/ba')}}" data-language="ba" data-text-direction="ltr">
                                    <span class="align-middle">Bosanski</span>
                                </a>
                            </li>
                            <li>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-styles">
                            <li>
                                <a class="dropdown-item" href="javascript:void(0);" data-theme="light">
                                    <span class="align-middle"><i class='ti ti-sun me-2'></i>Svijetli</span>
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="javascript:void(0);" data-theme="dark">
                                    <span class="align-middle"><i class="ti ti-moon me-2"></i>Tamni</span>
                                </a>
                            </li>
                            <li>
                        ...
                        <div class="dropdown-menu dropdown-menu-end py-0">
                            <div class="dropdown-menu-header border-bottom">
                                <div class="dropdown-header d-flex align-items-center py-3">
                                    <h5 class="text-body mb-0 me-auto">Kratice</h5>
                            ...
                            <div class="dropdown-shortcuts-list scrollable-container">
                                <div class="row row-bordered overflow-visible g-0">
                                    <div class="dropdown-shortcuts-item col">
                                        ...
                                        <a href="{{url('app/calendar')}}" class="stretched-link">Termini</a>
                                        <small class="text-muted mb-0">Kalendar</small>
                                    </div>
                                    <div class="dropdown-shortcuts-item col">
                                        <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                                            <i class="ti ti-file-invoice fs-4"></i>
                                        </span>
                                        <a href="{{url('app/invoice/list')}}" class="stretched-link">Nalazi</a>
                                        <small class="text-muted mb-0">Upravljanje</small>
                                    </div>
                                </div>
                                <div class="row row-bordered overflow-visible g-0">
                                    <div class="dropdown-shortcuts-item col">
                                        ...
                                        <a href="{{url('app/user/list')}}" class="stretched-link">Pacijenti</a>
                                        <small class="text-muted mb-0">Upravljanje</small>
                                    </div>
                                    <div class="dropdown-shortcuts-item col">
                                        <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                                ...
                                <div class="row row-bordered overflow-visible g-0">
                                    ...
                                    <div class="dropdown-shortcuts-item col">
                                        ...
                                        <a href="{{url('pages/account-settings-account')}}"
                                            class="stretched-link">Postavke</a>
                                        <small class="text-muted mb-0">Upravljaj</small>
                                    </div>
                                </div>
                                <div class="row row-bordered overflow-visible g-0">
                                    <div class="dropdown-shortcuts-item col">
                    ...
                    <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-1">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end py-0">
                            <li class="dropdown-menu-header border-bottom">
                                <div class="dropdown-header d-flex align-items-center py-3">
                                    <h5 class="text-body mb-0 me-auto">Notifikacije</h5>
                                    <a href="javascript:void(0)" class="dropdown-notifications-all text-body"
                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                        title="Markiraj sve kao pročitane"><i class="ti ti-mail-opened fs-4"></i></a>
                                </div>
                            </li>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li>
                                <a class="dropdown-item" href="{{ route('logout') }}"
                                    ...
                                    <span class="align-middle">Odjavite se</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a class="dropdown-item"
                                    href="{{ Route::has('auth/login') ? route('aut/login') : url('auth/login') }}">
                                    <i class='ti ti-login me-2'></i>
                                    <span class="align-middle">Prijavite se</span>
                                </a>
                            </li>
                            @endif
                        </ul>
